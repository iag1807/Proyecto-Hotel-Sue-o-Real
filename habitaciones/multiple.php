...
<head>
    ...
    <title>Habitación Multiple</title>
    ...
    <div class="contenedor">
        <div class="seccion-galeria">
            <div class="imagen-principal">
                <img src="../imagenes/multiple.jpeg" alt="" loading="lazy">
            </div>
            <div class="imagenes-secundarias">
                ...
                <div class="imagen">
                    <img src="../imagenes/multiple1.jpg" alt="" loading="lazy">
                </div>
                <div class="imagen">
                    <img src="../imagenes/multiple2.jpg" alt="" loading="lazy">
                </div>
                <div class="imagen">
                    <img src="../imagenes/imagen2.jpg" alt="" loading="lazy">
                </div>
                <div class="imagen">
                    <img src="../imagenes/multiple3.jpg" alt="" loading="lazy">
                </div>
            </div>
</div>
            ...
            <div class="detalles-habitacion">
                <div class="detalles">
                    ...
                    <div class="detalles-text">
                        <h3>Capacidad</h3>
                        <p> De 5 a 10 personas · Cama de un metro y dos camarotes </p>
                    </div>
                </div>
