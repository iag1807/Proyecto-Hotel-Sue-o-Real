...
<body>
    <header>
        ...
        <div class="seccion-header">
            <h1 class="titulo"> HABITACIÓN <span> TRIPLE </span></h1>
    ...
    <div class="contenedor">
        <div class="seccion-galeria">
            <div class="imagen-principal">
                <img src="../imagenes/triple.jpeg" alt="" loading="lazy">
            </div>
            <div class="imagenes-secundarias">
                ...
                <div class="imagen">
                    <img src="../imagenes/triple1.jpg" alt="" loading="lazy">
                </div>
                <div class="imagen">
                    <img src="../imagenes/sencilla4.jpg" alt="" loading="lazy">
                </div>
                <div class="imagen">
                    <img src="../imagenes/triple2.jpg" alt="" loading="lazy">
                </div>
                <div class="imagen">
            ...
            <div class="detalles-habitacion">
                <div class="detalles">
                    ...
                    <div class="detalles-text">
                        <h3>Capacidad</h3>
                        <p>De 3 a 6 personas · Cama semidoble y camarote </p>
                    </div>
                </div>
